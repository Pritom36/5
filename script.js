document.addEventListener('DOMContentLoaded', () => {
        ...
        comicsToShow.forEach(comic => {
            ...
            card.innerHTML = `
                ...
                <div class="comic-info">
                    ...
                    <div class="comic-actions"> <a href="#" class="comic-link" data-comic-id="${comic.id}">Read Now</a> <button class="vocab-assistant-btn" data-vocab-id="${comic.vocabId}" aria-label="Open Vocabulary for ${comic.title}"><i class="fas fa-book"></i></button> </div>
                </div>`;
    ...
    function setupEventListeners() {
        ...
        comicsListContainer.addEventListener('click', (e) => {
            ...
            if (link) { e.preventDefault(); openImageViewerModal(link.dataset.comicId); }
